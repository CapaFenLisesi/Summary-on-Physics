...
\[H = \int_{\Sigma_t} \mathcal{H}(p,q,q_a)d^3y\]
...
\[\overrightarrow {f}=\frac{d\overrightarrow {p}}{dt} = e(\overrightarrow {E} + \overrightarrow {v} \times \overrightarrow {B})\]
...
\begin{eqnarray}
\frac{1}{\sqrt{h}}\frac{\partial}{\partial t}(\sqrt{h} \overrightarrow{E}) &=& \nabla \times (N \overrightarrow{B} - \overrightarrow{N} \times \overrightarrow{E}) - N \overrightarrow{J} \nonumber \\
\frac{1}{\sqrt{h}}\frac{\partial}{\partial t}(\sqrt{h} \overrightarrow{B}) &=& -\nabla \times (N \overrightarrow{E} + \overrightarrow{N} \times \overrightarrow{B}) \nonumber \\
\nabla \cdot \overrightarrow{E} &=& \rho_e \nonumber \\
