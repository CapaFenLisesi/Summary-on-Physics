...
\section{Heisenberg picture of fields}
\noindent
...
\[\langle \phi_b(\vec{x}) | e^{-iHT} | \phi_a(\vec{x}) \rangle = \int \mathcal{D}\phi \mathcal{D}\pi  \mathrm{exp} \left[ i\int_0^T d^4x (\pi\dot{\phi} - \frac{1}{2}\pi^2 - \frac{1}{2}(\nabla \phi)^2 -V(\phi))\right]\]
...
\begin{eqnarray}
\mathcal{L} &=& -\frac{1}{2}\partial_{\mu} \phi \partial^{\mu} \phi -\frac{1}{2}m_0^2 \phi^2 -\frac{\lambda_0}{4!}\phi^4 \nonumber \\
\mathcal{L} &=& \mathcal{L}_0 + \mathcal{L}_1 \quad \mathcal{L}_1 =- \frac{\lambda_0}{4!} \phi^4 (\vec{x}) \nonumber \\
...
\begin{enumerate}
\item Super-Re-normalizable theory: Only a finite number of Feynman diagrams superficially diverge.
\item Re-normalizable theory: Only a finite number of amplitudes superficially diverge; however, divergences
occur at all orders in perturbation theory. 
\item Non-Re-normalizable theory: All amplitudes are divergent at a sufficiently high order in perturbation
theory.
\end{enumerate}
...
\begin{enumerate}
\item Super-Re-normalizable: Coupling constant has positive mass dimension.
\item  Re-normalizable: Coupling constant is dimensionless.
\item  Non-Re-normalizable: Coupling constant has negative mass dimension.
\end{enumerate}
...
The re-normalization scheme here is called on-shell (OS) scheme. Other re-normalization scheme would be introduced later.
...
\subsection{The re-normalization group}
\noindent
The Lagrangian of $\phi^4$ theory is 
...
\subsection{Re-normalization and symmetry}
