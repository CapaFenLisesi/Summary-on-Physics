...
\begin{figure}
\centering
\includegraphics[scale=0.2]{GR/Penrose1.png}
...
\begin{figure}[!htb]
\centering
\includegraphics[scale=0.3]{GR/Penrose2.eps}
...
The singularity at $r = 0$ is a timelike line, as in the other cases.
 So for this black hole you can again avoid the singularity and continue to move to the future to extra copies of the asymptotically flat region, but the singularity is always ``to the left''. 
\\ \\
...
So $\Delta(r) = 0$ is a null surface.
...
where $E$ is the conserved ``energy'' of the photon. So it is easy to see that the surface with $g_{tt} = 0$ corresponds to infinite redshift.
