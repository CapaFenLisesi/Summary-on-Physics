...
So the S matrix element can be represented by the following diagram.
\begin{figure}[!h]
\centering
...
We can calculate that $M_1 = \frac{1}{2}b_1 - \frac{1}{2}a_1 = \frac{\lambda}{32\pi^2} + \mathcal{O}(\lambda^2)$.
