...
\[H = \frac{(\bm{P}+e\bm{A})^2}{2m} - \frac{e^2}{4\pi r} + H_{FS} + \frac{e}{m}\bm{S}\cdot\bm{B}\]
...
Suppose the typical energy of the term $H_{i}$ is $E_i$, then we have $E_a \sim \frac{me^4}{32 n^2 \pi^2\hbar^2\epsilon_0^2}$, $E_z \sim \frac{ne\hbar B}{2m}$ and $E_B \sim \frac{e^2}{8mc^2}n^4 a_0^2 = \frac{2n^4\pi^2 \epsilon_0^2 \hbar^4 B^2}{m^3 e^2}$. So
...
The eigenvector of $H$ is $|nlm_lm_s\rangle$ with eigenvalue $E = E_n + \frac{eB}{2m}(m_l+2m_s)$.
\begin{figure}[!h]
	\centering
...
\[\Delta E = \frac{eB}{2m}\langle n l j m_j | L_z + 2S_z | n l j m_j\rangle = g_{eff} \frac{eB}{2m} m_j\]
where
