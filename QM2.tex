...
\[\psi(x) = e^{iW(x)/\hbar}\]
Plugging this ansatz into the Schrödinger equation leaves us with the differential equation
...
To proceed, we substitute our ansatz into the Schrödinger equation to find
