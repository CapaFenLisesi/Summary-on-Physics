...
\begin{figure}[!h]
\centering
\includegraphics[height=2cm ,width=5.4cm]{QFT3/FD1.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=4.5cm ,width=6.85cm]{QFT3/FD2.png}
\caption{Feynman diagram representation of perturbation expansion}
\end{figure}\\
...
\begin{figure}[!h]
\centering
\includegraphics[height=2cm ,width=4.46cm]{QFT3/WI1.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=1.67cm ,width=11.36cm]{QFT3/WI2.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=1.08cm ,width=13.65cm]{QFT3/RG1.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=2.86cm ,width=5.31cm]{QFT3/WI4.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=5.44cm ,width=8.24cm]{QFT3/RG2.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=2.22cm ,width=9.21cm]{QFT3/RG3.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=1.98cm ,width=7.77cm]{QFT3/RG4.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=2.75cm ,width=4.11cm]{QFT3/RG5.png}
...
\begin{figure}[!h]
\centering
\includegraphics[height=2.97cm ,width=10.65cm]{QFT3/EES.png}
...
\[\overline{u}_{s'}(\bm{p}')\Gamma^{\mu}(p',p)u_s(\bm{p}) = \overline{u}'\left[F_1(q^2)\gamma^{\mu} - \frac{i}{m}F_2(q^2)S^{\mu\nu}q_{\nu}\right]u_s(\bm{p})\]
...
F_2(q^2) &=& \frac{e^2}{8\pi^2} \int dF_3 \frac{x_3-x_3^2}{x_1x_2q^2/m^2 + (1-x_3)^2} + O(e^4) \nonumber
\end{eqnarray}

The loop corrections of QED are related to anomalous magnetic moment of electrons and lamb shift of energy level in hydrogen atom. We will not discuss these interesting phenomenon in this notes. Discussion on anomalous magnetic moment can be found in chapter 6.2 of \emph{An introduction to quantum field theory (M.E.Peskin \& D.V.Schroeder)}. You can also find some comments on lamb shift due to vacuum polarization in chapter 7.5 . And a detailed treatment of infrared divergence is available in chapter 6.1, 6.4 and 6.5.
